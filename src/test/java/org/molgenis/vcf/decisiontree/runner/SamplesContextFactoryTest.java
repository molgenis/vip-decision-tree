  ...
  void create() throws FileNotFoundException {
    ...
    SampleContext patient =
        SampleContext.builder()
            ...
            .fatherId("Father")
            .motherId("Mother")
            .phenotypes(List.of("HP:123"))
            .proband(true)
            .sex(Sex.MALE)
            .affectedStatus(AffectedStatus.AFFECTED)
            .build();
    SampleContext mother =
        SampleContext.builder()
            .id("Mother")
            .index(1)
            .familyId("FAM001")
  ...
  void createDefaultSampleContext() {
    SampleContext expected =
        SampleContext.builder()
            .id("sample")
            .index(2)
            .phenotypes(List.of("HP3", "HP4"))
            .proband(true)
            .sex(Sex.UNKNOWN)
            .affectedStatus(AffectedStatus.MISSING)
            .build();
    SampleContext actual =
        SamplesContextFactory.createDefaultSampleContext(
            "sample",
            2,
            List.of("HP1", "HP2"),
            Map.of("sample", List.of("HP3", "HP4")),
            List.of("sample"));
