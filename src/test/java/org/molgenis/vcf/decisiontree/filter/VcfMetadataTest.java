...
class VcfMetadataTest {
  ...
  void setUp() {
    ...
    NestedHeaderLine nestedVepHeaderLine =
        NestedHeaderLine.builder().nestedFields(vepNestedMetadata).parentField(vepField).build();
    NestedHeaderLine nestedGtHeaderLine =
        NestedHeaderLine.builder().nestedFields(Map.of()).parentField(vepField).build();
  ...
  void getNestedFieldInfoUnknownParentStrict() {
    assertThrows(
        UnsupportedNestedFieldException.class,
  ...
  void getNestedFieldInfoString() {
    ...
    assertEquals(createNestedField("consequence"), vcfMetadata.getField(fieldId));
  }
  ...
  void getFieldSampleInvalid() {
    assertThrows(
        UnsupportedFieldException.class, () -> vcfMetadataStrict.getField("SAMPLE/unknown"));
  }
